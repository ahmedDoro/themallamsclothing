		...
		<div class="navbar navbar-inverse navbar-fixed-top">
			<div class="container-fluid">
				...
				<ul class="nav navbar-nav navbar-right">
					<li><a href="#" id="basket_container" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span>Basket<span class="badge">0</span></a>
					...
					<li><a href="#" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-user"><?php echo "Hi," .$_SESSION["name"]; ?></span></a>
					<ul class="dropdown-menu">
						<li><a href="basket.php" style='text-decoration:none; color:blue;'><span class="glyphicon glyphicon-shopping-cart" ></span>Basket</span></a></li>
						<li class="divider"></li>
						<li><a href="account.php" style='text-decoration:none; color:blue;'>Manage Account</a></li>
						<li class="divider"></li>
